...
class TfPoseEstimator:
    ...
    def draw_humans(npimg, humans, imgcopy=False):
        ...
        # Stores the coordinates of parts detected for each person.
        centers = {}

        #centers = collections.defaultdict(2)
        ...
        for k, human in enumerate(humans):
            ...
            # To store parts of each human separately
            centers[k+1] = {}
            ...
            for pair_order, pair in enumerate(common.CocoPairsRender):
                ...
                cv2.line(npimg, centers[k+1][pair[0]], centers[k+1][pair[1]], common.CocoColors[pair_order], 3)
        #print(centers[0])
